  ...
  return (
    <section>
      <div className="transform w-full flex flex-col-reverse md:flex-row">
        <div className="md:w-1/2 lg:pl-[164px] pt-[62px] md:pt-0 lg:pt-[160px] lg:pr-[100px] text-center md:text-left">
          <h2 className="text-[33px] md:text-[41px] font-fraunces font-black leading-[40px] md:leading-[47px]">
            Transform your brand
          </h2>
          <p className="mt-[25px] md:mt-[35px] mx-[20px] md:mx-0 text-[17.78px] leading-[29px] text-dark-grayish-blue">
            We are a full-service creative agency specializing in helping brands
            grow fast. Engage your clients through compelling visuals that do
            most of the marketing for you.
          </p>
          <a
            className="block relative font-fraunces font-black uppercase mt-[35px] mb-[65px]  md:my-[41px] mx-[9px] tracking-[0.5px] transition-all"
            href=""
          >
            Learn more
          </a>
      ...
      <div className="standout w-full flex flex-col-reverse md:flex-row-reverse">
        <div className="md:w-1/2 px-[30px] lg:pl-[110px] lg:pr-[160px] pt-[64px] md:pt-0 lg:pt-[158px] text-center md:text-left">
          <h2 className="text-[33px] md:text-[40.7px] font-fraunces font-black leading-[39px] md:leading-[48px]">
            Stand out to the right audience
          </h2>
          <p className="mt-[26px] md:mt-[35px] text-[17.78px] leading-[29px] text-dark-grayish-blue">
            Using a collaborative formula of designers, researchers,
            photographers, videographers, and copywriters, we’ll build and
            extend your brand in digital places.
          </p>
          <a
            className="block relative font-fraunces font-black uppercase mt-[36px] mb-[65px] md:my-[42px] mx-[7px] tracking-[0.5px] transition-all"
            href=""
          >
            Learn more
          </a>
      ...
      <div className="design w-full flex flex-col md:flex-row md:h-[600px]">
        <div className="bg-graphic md:w-1/2 flex flex-col items-center justify-end h-[600px] md:h-full">
          <div className="text-center mb-[59px] max-w-[340px] text-dark-desaturated-cyan">
        ...
        <div className="bg-photography md:w-1/2 flex flex-col items-center justify-end h-[600px] md:h-full">
          <div className="text-center mb-[59px] max-w-[340px] text-dark-blue">
            <h2 className="text-[29px] font-fraunces font-black leading-[48px] tracking-[-0.54px]">
              Photography
            </h2>
            <p className="text-[15.8px] leading-[27.5px] mt-[20px] ">
